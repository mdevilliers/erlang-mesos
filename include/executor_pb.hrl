...
%% Generated by gpb_compile version 3.19.0 on {{2016,2,17},{13,22,31}}
...
-record('mesos.v1.executor.Call',
        {executor_id,                   % = 1, {msg,'mesos.v1.ExecutorID'}
         ...
         type,                          % = 3, {enum,'mesos.v1.executor.Call.Type'}
...
-ifndef('MESOS.V1.EXECUTOR.EVENT.SHUTDOWN_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.SHUTDOWN_PB_H', true).
-record('mesos.v1.executor.Event.Shutdown',
        {grace_period_seconds = 5.0     % = 1, double (optional)
        }).
-endif.
...
-record('mesos.v1.executor.Event',
        {type,                          % = 1, {enum,'mesos.v1.executor.Event.Type'}
         ...
         shutdown,                      % = 7, {msg,'mesos.v1.executor.Event.Shutdown'} (optional)
         error                          % = 8, {msg,'mesos.v1.executor.Event.Error'} (optional)
        }).
-endif.
