...
%% Generated by gpb_compile version 3.19.0 on {{2016,2,7},{21,9,56}}
...
-ifndef('MESOS.V1.COMMANDINFO.CONTAINERINFO_PB_H').
-define('MESOS.V1.COMMANDINFO.CONTAINERINFO_PB_H', true).
...
-record('mesos.v1.executor.Call.Subscribe',
        {tasks = [],                    % = 1, [{msg,'mesos.v1.TaskInfo'}]
         updates = []                   % = 2, [{msg,'mesos.v1.executor.Call.Update'}]
        }).
-endif.
